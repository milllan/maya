...
/**
 * Provides a markup for the 'Mayan Sign detailed pdf.
 *
...
<body>
		...
		<div class="center-table report-table ">
			...
			<table class="report-table-inner">
				...
				<tr class="<?php if ($_POST['life_phase'] == 'youth') echo 'table-row_active' ?>">
					...
					echo '<img src="' . $_POST['tone']['stage_line_img'] . '"><span>' . __("You are here, at this moment of your life.", 'my-mayan-sign') . "</span>";
				} ?>
					</td>
					<td>
						<div class="report_icon-details-single">
							<p>
								<?php _e('Youth', 'my-mayan-sign'); ?>
							</p>
						</div>
					</td>
	...
	<div class="report-single_main-heading">
		<h2>
			<?php _e('Stage of Youth', 'my-mayan-sign'); ?>
		</h2>
	</div>
	...
	<div class="report-single">
		<div class="report-single_heading">
			<img src="<?php echo $_POST['youth_female']['img']; ?>">
			<h2>
				<?php _e('Your Youth Female Sign - ', 'my-mayan-sign'); ?>
				<?php echo $_POST['youth_female']['title']; ?>
			</h2>
		</div>
		<p>
			<?php echo $_POST['youth_female']['minor_text']; ?>
		</p>
	</div>
	...
	<div class="report-single">
		<div class="report-single_heading">
			...
			<h2>
				<?php _e('Your Youth Female Tone - ', 'my-mayan-sign'); ?>
				<?php echo $_POST['tone']['youth_female_tone_txt']['title']; ?>
			</h2>
		</div>
		<p>
			<?php echo $_POST['tone']['youth_female_tone_txt']['minor_text']; ?>
		</p>
	</div>
	...
	<div class="report-single">
		<div class="report-single_heading">
			...
			<h2>
				<?php _e('Your Youth Male Sign - ', 'my-mayan-sign'); ?>
				<?php echo $_POST['youth_male']['title']; ?>
			</h2>
		</div>
		<p>
			<?php echo $_POST['youth_male']['minor_text']; ?>
		</p>
	</div>
	...
	<div class="report-single">
		<div class="report-single_heading">
			...
			<h2>
				<?php _e('Your Youth Male Tone - ', 'my-mayan-sign'); ?>
				<?php echo $_POST['tone']['youth_male_tone_txt']['title']; ?>
			</h2>
		</div>
		<p>
			<?php echo $_POST['tone']['youth_male_tone_txt']['minor_text']; ?>
		</p>
	</div>
	...
	<div class="report-single_main-heading">
		<h2>
			<?php _e('Adult Stage', 'my-mayan-sign'); ?>
		</h2>
	</div>
	...
	<div class="report-single">
		<div class="report-single_heading">
			<img src="<?php echo $_POST['day_sign']['img']; ?>">
			<h2>
				<?php _e('Your Day (Adult) Sign - ', 'my-mayan-sign'); ?>
	...
	<div class="report-single_main-heading">
		<h2>
			<?php _e('Mature Life Stage', 'my-mayan-sign'); ?>
		</h2>
	</div>
	...
	<div class="report-single">
		<div class="report-single_heading">
			<img src="<?php echo $_POST['destiny_female']['img']; ?>">
			<h2>
				<?php _e('Your Mature Female Sign - ', 'my-mayan-sign'); ?>
				<?php echo $_POST['destiny_female']['title']; ?>
			</h2>
		</div>
		<p>
			<?php echo $_POST['destiny_female']['minor_text']; ?>
		</p>
	</div>
	...
	<div class="report-single">
		<div class="report-single_heading">
			...
			<h2>
				<?php _e('Your Mature Female Tone - ', 'my-mayan-sign'); ?>
				<?php echo $_POST['tone']['destiny_female_tone_txt']['title']; ?>
			</h2>
		</div>
		<p>
			<?php echo $_POST['tone']['destiny_female_tone_txt']['minor_text']; ?>
		</p>
	</div>
	...
	<div class="report-single">
		<div class="report-single_heading">
			<img src="<?php echo $_POST['destiny_male']['img']; ?>">
			<h2>
				<?php _e('Your Mature Male Sign - ', 'my-mayan-sign'); ?>
				<?php echo $_POST['destiny_male']['title']; ?>
			</h2>
		</div>
		<p>
			<?php echo $_POST['destiny_male']['minor_text']; ?>
		</p>
	</div>
	...
	<div class="report-single">
		<div class="report-single_heading">
			...
			<h2>
				<?php _e('Your Mature Male Tone - ', 'my-mayan-sign'); ?>
				<?php echo $_POST['tone']['destiny_male_tone_txt']['title']; ?>
			</h2>
		</div>
		<p>
			<?php echo $_POST['tone']['destiny_male_tone_txt']['minor_text']; ?>
		</p>
	</div>
	...
	<div class="report-single_main-heading">
		<h2>
			<?php _e('Night lords', 'my-mayan-sign'); ?>
		</h2>
	</div>
	...
	<div class="report-single">
		<div class="report-single_heading">
			<h2>
				<?php echo $_POST['static_text']['night_lord_title']['text'] ?>
			</h2>
		</div>
		<p>
			<?php echo $_POST['static_text']['night_lord_text']['text'] ?>
		</p>
		<div class="report-single_heading">
			<h2>
				<?php echo $_POST['night_lord']['title'] ?>
			</h2>
		</div>
		<p>
			<?php echo stripslashes($_POST['night_lord']['content']) ?>
		</p>
	</div>
	</div>
