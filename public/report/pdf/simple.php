...
/**
 * Provides a markup for the 'Mayan Sign simple pdf.
 *
			...
			<table class="report-table-inner">
				...
				<tr class="<?php if($_POST['life_phase'] == 'youth' || $_POST['life_phase'] == 'youth_adult') echo 'table-row_active'?>">
					...
					<td class="sign-size_<?php echo $_POST['tone']['youth_tone']; ?>">
						<a href="<?php echo $_POST['upgrade_to_standard']; ?>" target="_blank" class="sign-images">
							<div class="sign-images_overlay-wrapper">
								<img class="mymasi_sign_image sign-images_overlay" src="<?php echo $_POST['youth']['img']; ?>">
				...
				<tr class="<?php if($_POST['life_phase'] == 'youth_adult' || $_POST['life_phase'] == 'adult') echo 'table-row_active'?>">
					...
					<td class="sign-size_<?php echo $_POST['tone']['male_tone']; ?>">
						<a href="<?php echo $_POST['upgrade_to_standard']; ?>" target="_blank" class="sign-images">
							<div class="sign-images_overlay-wrapper">
								<img class="mymasi_sign_image sign-images_overlay" src="<?php echo $_POST['male']['img']; ?>">
					...
					<td class="sign-size_<?php echo $_POST['tone']['female_tone']; ?>">
						<a href="<?php echo $_POST['upgrade_to_standard']; ?>" target="_blank" class="sign-images">
							<div class="sign-images_overlay-wrapper">
								<img class="mymasi_sign_image sign-images_overlay" src="<?php echo $_POST['female']['img']; ?>">
				...
				<tr class="<?php if($_POST['life_phase'] == 'adult_mature' || $_POST['life_phase'] == 'mature') echo 'table-row_active'?>">
					...
					<td class="sign-size_<?php echo $_POST['tone']['future_tone']; ?>">
						<a href="<?php echo $_POST['upgrade_to_standard']; ?>" target="_blank" class="sign-images">
							<div class="sign-images_overlay-wrapper">
								<img class="mymasi_sign_image sign-images_overlay" src="<?php echo $_POST['future']['img']; ?>">
	...
	<div class="report-upgrade-wrapper">
		...
		<div class="upgrade-button-wrapper">
			<table>
				<tr>
					<td>
						<a href="<?php echo $_POST['upgrade_to_standard']; ?>" target="_blank" class="upgrade-button">
							<?php _e('Upgrade to Standard report', 'my-mayan-sign'); ?>
						</a>
					</td>
					<td>
						<p class="upgrade-button-separator">
							<?php _e('or', 'my-mayan-sign') ?>
						</p>
					</td>
					<td>
