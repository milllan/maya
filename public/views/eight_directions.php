...
<input type="button" value="Email" onclick="window.location.href = window.location.href + '?pdf=true';">
  ...
  <tr>
    <td class="mymasi_sign_image_size_1">
...
<h2><?php _e('Your Youth Male Sign', 'my-mayan-sign'); ?></h2>

<h3><?php echo $_POST['youth_male']['title']; ?></h3>
<img src="<?php echo $_POST['youth_male']['img']; ?>">
<p><?php echo $_POST['youth_male']['content']; ?></p>

<h2><?php _e('Your Youth Female Sign', 'my-mayan-sign'); ?></h2>

<h3><?php echo $_POST['youth_female']['title']; ?></h3>
<img src="<?php echo $_POST['youth_female']['img']; ?>">
<p><?php echo $_POST['youth_female']['content']; ?></p>
...
<h2><?php _e('Your Destiny Male Sign', 'my-mayan-sign'); ?></h2>

<h3><?php echo $_POST['destiny_male']['title']; ?></h3>
<img src="<?php echo $_POST['destiny_male']['img']; ?>">
<p><?php echo $_POST['destiny_male']['content']; ?></p>

<h2><?php _e('Your Destiny Female Sign', 'my-mayan-sign'); ?></h2>

<h3><?php echo $_POST['destiny_female']['title']; ?></h3>
<img src="<?php echo $_POST['destiny_female']['img']; ?>">
<p><?php echo $_POST['destiny_female']['content']; ?></p>
